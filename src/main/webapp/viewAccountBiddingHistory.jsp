  ...
  border-spacing: 15px;
	...
	<%
		...
		try {
			...
			String username = request.getParameter("usernameBidder");
			%>
			
			<h1> <%= username + "'s Bidding History"%></h1>
			<%
			//Make a SELECT query from the sells table with the price range specified by the 'price' parameter at the index.jsp
			String str = "SELECT DISTINCT * FROM bids b WHERE b.bidder = '" + username + "'";
